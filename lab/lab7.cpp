...
void SetupRC()
{
	...
	Mat image = imread("C:\\Users\\tim\\Downloads\\block1\\block\\Block4.jpg");
	if (image.empty()) {
		...
		glTexImage2D(GL_TEXTURE_2D,
			0, GL_RGB, image.cols, image.rows, 0, GL_BGR_EXT, GL_UNSIGNED_BYTE, image.ptr());

	 image = imread("C:\\Users\\tim\\Downloads\\block1\\block\\Block5.jpg");
		if (image.empty()) {
			cout << "Can not load the image!" << std::endl;
		}
		...
		glTexImage2D(GL_TEXTURE_2D,
			0, GL_RGB, image.cols, image.rows, 0, GL_BGR_EXT, GL_UNSIGNED_BYTE, image.ptr());
		image = imread("C:\\Users\\tim\\Downloads\\block1\\block\\Block6.jpg");
		if (image.empty()) {
			cout << "Can not load the image!" << std::endl;
		}
		...
		glTexImage2D(GL_TEXTURE_2D,
			0, GL_RGB, image.cols, image.rows, 0, GL_BGR_EXT, GL_UNSIGNED_BYTE, image.ptr());
		image = imread("C:\\Users\\tim\\Downloads\\block1\\block\\floor.jpg");
		if (image.empty()) {
			cout << "Can not load the image!" << std::endl;
		}
